...
public class ApplicationUserDto
{
    ...
    [Description("Time Zone")] public string? TimeZoneId { get; set; }
    ...
    [Description("Last Modified")] public DateTime? LastModified { get; set; }
    [Description("Last Modified By")] public string? LastModifiedBy { get; set; }
    [Description("CreatedOn")] public DateTime? Created { get; set; }
    [Description("CreatedOn By")] public string? CreatedBy { get; set; }
    [Description("CreatedOn By User")] public ApplicationUserDto? CreatedByUser { get; set; }
    [Description("Last Modified By User")] public ApplicationUserDto? LastModifiedByUser { get; set; }
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<ApplicationUser, ApplicationUserDto>(MemberList.None)
                ...
                .ForMember(x => x.Superior, s => s.MapFrom(y => y.Superior != null
                    ...
                    : null))
                .ForMember(x => x.CreatedByUser, s => s.MapFrom(y => y.CreatedByUser != null
                    ? new ApplicationUserDto()
                    {
                    ...
                    : null))
                .ForMember(x => x.LastModifiedByUser, s => s.MapFrom(y => y.LastModifiedByUser != null
                    ? new ApplicationUserDto()
                    {
